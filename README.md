...
`ai-team-workflow` is an AI product delivery workflow plugin for Codex and Claude Code. It provides a shared `.ai-team` workflow core with isolated Codex / Claude Code entry packages.
...
Pushing a version tag creates a GitHub Release and uploads the zip packages automatically:
